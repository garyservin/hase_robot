#ifndef _ROS_sensor_msgs_ImuLite_h
#define _ROS_sensor_msgs_ImuLite_h
...
namespace hase_firmware
{
  ...
  class ImuLite : public ros::Msg
  {
    ...
    virtual const char * getType(){ return "hase_firmware/ImuLite"; };
    virtual const char * getMD5(){ return "69f0756e896955a61f27c7dd4838f021"; };
